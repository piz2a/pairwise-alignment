...
function App() {
    ...
    const { array, arrows, resultArrows, alignmentResults, alignmentScore } = Algorithm(algorithm, string1, string2, score);
        ...
        <div className="App">
            <div className="header">
                <div className="titleWrapper">
                    ...
                    <a href="https://github.com/piz2a/pairwise-alignment"><img src="github.svg" alt="Github"/></a>
                </div>
                <hr/>
            </div>
            <div className="main">
                <div className="left">
                    <div className="inputWrapper">
                        ...
                        <div className="stringWrapper">
                            <StringInput className={"string2"} label={"Top Sequence"} defaultValue={defaultString2}
                                         onChange={e => setString2(e.target.value)}/>
                            <StringInput className={"string1"} label={"Bottom Sequence"} defaultValue={defaultString1}
                        ...
                        <div className="resultWrapper">
                            <span>Alignment Results ({algorithm === "needleman-wunsch" ? "Global" : "Local"} Alignment Score: <span
                                style={{fontWeight: "bold"}}>{alignmentScore}</span>)</span>
                            <textarea value={
